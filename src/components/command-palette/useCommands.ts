...
export function buildStaticCommands(navigate: ReturnType<typeof useNavigate>): CommandAction[] {
  ...
  return [
    ...
    {
      id: 'action.export_customers_csv',
      group: 'Azioni',
      label: 'Esporta CSV clienti',
      hint: 'Salva sul disco',
      icon: FileSpreadsheet,
      keywords: ['csv', 'clienti', 'esporta'],
      perform: run('CSV clienti salvato', () => ipc.exportData.csv('customers')),
    },
    {
      id: 'action.export_printers_csv',
      group: 'Azioni',
      label: 'Esporta CSV stampanti',
      hint: 'Salva sul disco',
      icon: FileSpreadsheet,
      keywords: ['csv', 'stampanti', 'esporta'],
      perform: run('CSV stampanti salvato', () => ipc.exportData.csv('printers')),
    },
    {
